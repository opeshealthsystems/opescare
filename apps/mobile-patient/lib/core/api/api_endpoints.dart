abstract final class ApiEndpoints {
  ...
  //   --dart-define=API_BASE_URL=https://mobile-api.opescare.com/api
  ...
  static const String _base = String.fromEnvironment('API_BASE_URL',
      defaultValue: 'http://opescare.test/api');
  static const String webBaseUrl = String.fromEnvironment('WEB_BASE_URL',
      defaultValue: 'http://opescare.test');
  ...
  static String get resendOtp => '${baseUrl}/mobile/auth/otp/resend';
  static String get forgotPassword => '$webBaseUrl/forgot-password';
  static String get registerPatient => '$webBaseUrl/signup/patient';
  ...
  static String approveConsent(String id) =>
      '${baseUrl}/mobile/consent-requests/$id/approve';
  static String denyConsent(String id) =>
      '${baseUrl}/mobile/consent-requests/$id/deny';
  static String revokeConsent(String id) =>
      '${baseUrl}/mobile/consents/$id/revoke';
  static String get accessLogs => '${baseUrl}/mobile/access-logs';
  static String get correctionRequests =>
      '${baseUrl}/mobile/correction-requests';
  static String get dataExportRequests =>
      '${baseUrl}/mobile/data-export-requests';
  static String dataExportDownload(String id) =>
      '${baseUrl}/mobile/data-exports/$id/download';
  ...
  static String prescription(String id) =>
      '${baseUrl}/mobile/prescriptions/$id';
  ...
  static String cancelAppointment(String id) =>
      '${baseUrl}/mobile/appointments/$id/cancel';
  ...
  static String facilitySlots(String id) =>
      '${baseUrl}/mobile/facilities/$id/slots';
  ...
  static String submitSurvey(String id) =>
      '${baseUrl}/mobile/surveys/$id/submit';

  // Medical Record Export
  static String get exportRecordsPdf =>
      '${baseUrl}/mobile/medical-records/export/pdf';
  static String get exportRecordsFhir =>
      '${baseUrl}/mobile/medical-records/export/fhir';
  ...
  static String get insuranceMarketplace =>
      '${baseUrl}/mobile/insurance/marketplace';
  static String insuranceMarketplacePlan(String id) =>
      '${baseUrl}/mobile/insurance/marketplace/plans/$id';
  static String insurancePurchasePlan(String id) =>
      '${baseUrl}/mobile/insurance/marketplace/plans/$id/purchase';
  ...
  static String familyMember(String id) =>
      '${baseUrl}/mobile/family/members/$id';
  static String familyInvitation(String id) =>
      '${baseUrl}/mobile/family/invitations/$id';

...
abstract final class AppColors {
  ...
  static const Color primaryTextStrong = Color(0xFF1E40AF);
  ...
  static const Color successAccent = Color(0xFF6EE7B7);
  static const Color successDot = Color(0xFF34D399);
  static const Color successTextStrong = Color(0xFF065F46);
  ...
  static const Color dangerTextStrong = Color(0xFF991B1B);

  static const Color info = Color(0xFF3B82F6);
  static const Color infoDark = Color(0xFF2563EB);
  static const Color infoLight = Color(0xFFEFF6FF);
  static const Color purple50 = Color(0xFFF5F3FF);
  static const Color purpleTextStrong = Color(0xFF4C1D95);
  ...
  static const Color primaryGridLine = Color(0x6693C5FD); // primary300 @ 40%
  static const Color primarySurface = Color(0x4D1565C0); // primary  @ 30%
  static const Color successBadgeSurface = Color(0x3310B981); // success @ 20%
  static const Color successBadgeBorder = Color(0x5910B981); // success @ 35%
  static const Color successBadgeFill = Color(0x3310B981); // success @ 20%
  static const Color successBadgeStroke = Color(0x6610B981); // success @ 40%

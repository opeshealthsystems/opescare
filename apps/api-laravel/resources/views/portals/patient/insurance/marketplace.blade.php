    ...
    <div class="card-grid">
        ...
        <div class="nav-card">
            ...
            <div class="gap-2" style="display:flex;flex-wrap:wrap;">
                ...
                <span class="badge badge-success"><i data-lucide="check"></i> Cashless</span>
                @endif
                @if($plan->copay_percentage)
                <span class="badge badge-neutral"><i data-lucide="percent"></i> {{ number_format($plan->copay_percentage, 0) }}% co-pay</span>
                @endif
            </div>

            <a href="{{ route('portals.patient.insurance.plan', $plan->id) }}" class="btn btn-primary btn-sm btn-block mt-3">
                <i data-lucide="info"></i> View &amp; Enroll
            </a>
        </div>
        @endforeach
    </div>

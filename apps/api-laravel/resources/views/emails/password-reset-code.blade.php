...
<head>
    ...
    <title>Reset Your OpesCare Password</title>
    <style>
...
<div class="container">
    ...
    <p class="body-text">
        Use the code below to reset your OpesCare password.
    ...
    <p class="ignore">If you did not request a password reset, you can safely ignore this email — your password will not be changed.</p>
    <div class="footer">

...
@section('content')
    <div class="auth-card">
        ...
        <div class="auth-step-head">
            ...
            <h1 class="auth-step-title">{{ __('onboarding.guardian.title') }}</h1>
            <p class="auth-step-sub">{{ __('onboarding.guardian.subtitle') }}</p>
        </div>
        ...
        @else
            ...
            <form action="{{ route('register.guardian.submit') }}" method="POST" class="auth-form">
                ...
                <div class="form-section">
                    <div class="form-section-title">{{ __('onboarding.guardian.sec_guardian') }}</div>

                    <div class="auth-form-row">
                        <div class="auth-form-group">
                            <label for="first_name" class="auth-label">{{ __('onboarding.patient.first_name') }} *</label>
                            <input type="text" id="first_name" name="first_name"
                                   class="auth-input{{ $errors->has('first_name') ? ' auth-input-error' : '' }}" required>
                        ...
                        <div class="auth-form-group">
                            ...
                            <input type="text" id="last_name" name="last_name"
                                   class="auth-input{{ $errors->has('last_name') ? ' auth-input-error' : '' }}" required>
                    ...
                    <div class="auth-form-row">
                        <div class="auth-form-group">
                            ...
                            <input type="date" id="dob" name="dob"
                                   class="auth-input{{ $errors->has('dob') ? ' auth-input-error' : '' }}" required>
                ...
                <div class="form-section">
                    <div class="form-section-title">{{ __('onboarding.guardian.sec_dependent') }}</div>

                    <div class="auth-form-group">
                        <label for="dep_name" class="auth-label">{{ __('onboarding.guardian.dep_name_lbl') }} *</label>
                        <input type="text" id="dep_name" name="dep_name"
                               class="auth-input{{ $errors->has('dep_name') ? ' auth-input-error' : '' }}"
                               required placeholder="Full Name of the dependent">
                    ...
                    <div class="auth-form-row">
                        <div class="auth-form-group">
                            ...
                            <input type="date" id="dep_dob" name="dep_dob"
                                   class="auth-input{{ $errors->has('dep_dob') ? ' auth-input-error' : '' }}" required>
                        ...
                        <div class="auth-form-group">
                            ...
                            <select id="dep_sex" name="dep_sex"
                                    class="auth-input{{ $errors->has('dep_sex') ? ' auth-input-error' : '' }}" required>
                    ...
                    <div class="auth-form-row">
                        ...
                        <div class="auth-form-group">
                            ...
                            <input type="text" id="dep_relationship" name="dep_relationship"
                                   class="auth-input{{ $errors->has('dep_relationship') ? ' auth-input-error' : '' }}"
                                   placeholder="Parent, Legal Guardian, Caregiver" required>
                    ...
                    <div class="auth-form-group">
                        ...
                        <textarea id="access_reason" name="access_reason"
                                  class="auth-input{{ $errors->has('access_reason') ? ' auth-input-error' : '' }}"
                                  style="min-height:80px;resize:vertical;" required
                                  placeholder="{{ __('onboarding.guardian.reason_desc') }}"></textarea>

...
<div class="sidebar-role-badge" style="background:rgba(37,99,235,.2);border-color:rgba(37,99,235,.4);color:#93C5FD;">
    <i data-lucide="file-text" style="width:.75rem;height:.75rem;display:inline;vertical-align:middle;margin-right:4px;"></i>
    {{ __('portal.billing_officer_role', [], $l) ?: 'Billing Officer' }}
</div>
...
<div class="sidebar-nav-section">
    ...
    <a href="{{ route('portals.staff.billing') }}" class="sidebar-link">
        ...
        <span>{{ __('public.portal.nav_billing', [], $l) ?: 'Billing & Claims' }}</span>
    </a>
    ...
    <a href="{{ route('portals.staff.analytics.financial') }}" class="sidebar-link">
        ...
        <span>{{ __('public.portal.nav_analytics', [], $l) ?: 'Financial Analytics' }}</span>
    </a>

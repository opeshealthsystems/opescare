...
<div class="sidebar-role-badge" style="background:rgba(37,99,235,.2);border-color:rgba(37,99,235,.4);color:#93C5FD;">
    <i data-lucide="upload-cloud" style="width:.75rem;height:.75rem;display:inline;vertical-align:middle;margin-right:4px;"></i>
    {{ __('portal.data_import_role', [], $l) ?: 'Data Import Officer' }}
</div>
...
<div class="sidebar-nav-section">
    <div class="sidebar-nav-label">{{ __('public.portal.nav_administration', [], $l) ?: 'Data Import' }}</div>
    <a href="{{ route('portals.staff.data_import.index') }}" class="sidebar-link">

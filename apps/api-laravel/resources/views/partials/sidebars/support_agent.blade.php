...
<div class="sidebar-role-badge" style="background:rgba(37,99,235,.2);border-color:rgba(37,99,235,.4);color:#93C5FD;">
    <i data-lucide="headset" style="width:.75rem;height:.75rem;display:inline;vertical-align:middle;margin-right:4px;"></i>
    {{ __('portal.support_agent_role', [], $l) ?: 'Support Agent' }}
</div>
...
<div class="sidebar-nav-section">
    ...
    <a href="{{ route('portals.staff.support') }}" class="sidebar-link">
        ...
        <span>{{ __('public.portal.nav_support', [], $l) ?: 'Support Tickets' }}</span>
    </a>

...
return [
    ...
    'subscription_payment_failed'         => 'We could not start the Mobile Money payment. No charge was made. Please try again.',
    ...
    'connect_client_created' => 'Client \':name\' created. ID: :id',
    'connect_client_action_done' => 'Client :action successfully.',
    'contact_message_received' => 'Thank you! Your message has been received. We\'ll be in touch shortly.',
    'secure_session_expired' => 'Your secure session expired. Please sign in again.',
    'mfa_setup_required' => 'Multi-factor authentication setup is required for this role. Contact an administrator to complete enrollment before signing in.',
    'auth_code_invalid' => 'The authentication code is invalid.',
    'patient_identity_duplicate' => 'A record matching this identity already exists in our master patient registry. Please contact assistance to recover your existing Health ID.',
    'developer_request_submitted' => 'Your API/developer request has been submitted. Our interoperability panel will review your system scopes.',
    'staff_account_activated' => 'Your secure staff account has been activated. You may now sign in.',
    ...
    'purchase_order_approved' => 'PO :number approved.',
    'qr_all_tokens_revoked' => 'All :count active QR token(s) have been revoked. Your Health ID is still valid — generate a new QR when needed.',
    'lost_card_reported' => 'Your lost card report has been recorded and all active QR codes have been deactivated. Your Health ID number (:health_id) remains valid — generate a new QR code anytime.',
];
